...
This repository contains the complete implementation of **Assignment–2**, where the goal is to **learn an unknown probability density function (PDF)** of a transformed random variable using a **Generative Adversarial Network (GAN)**.
...
Each NO₂ concentration value \(x\) is transformed using the following nonlinear function:
